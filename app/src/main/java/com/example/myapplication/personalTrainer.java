...
public class personalTrainer implements Serializable {
    ...
    String nama_trainer,pendidikan_formal, gym_home, on_call_area,
             akun_sosmed, pengalaman_kerja, tarif_pertemuan, sertifikasi, keahlian;

    private String imgUrl;
    public personalTrainer() {
    }

    public personalTrainer(String nama_trainer, String pendidikan_formal, String gym_home, String on_call_area,  String akun_sosmed, String pengalaman_kerja, String tarif_pertemuan, String sertifikasi, String keahlian,String imgUrl) {
